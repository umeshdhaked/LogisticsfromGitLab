...
interface Writer {
   ...
   void writeInt32List(int var1, List var2, boolean var3) throws IOException;

   void writeFixed32List(int var1, List var2, boolean var3) throws IOException;

   void writeInt64List(int var1, List var2, boolean var3) throws IOException;

   void writeUInt64List(int var1, List var2, boolean var3) throws IOException;

   void writeFixed64List(int var1, List var2, boolean var3) throws IOException;

   void writeFloatList(int var1, List var2, boolean var3) throws IOException;

   void writeDoubleList(int var1, List var2, boolean var3) throws IOException;

   void writeEnumList(int var1, List var2, boolean var3) throws IOException;

   void writeBoolList(int var1, List var2, boolean var3) throws IOException;

   void writeStringList(int var1, List var2) throws IOException;

   void writeBytesList(int var1, List var2) throws IOException;

   void writeUInt32List(int var1, List var2, boolean var3) throws IOException;

   void writeSFixed32List(int var1, List var2, boolean var3) throws IOException;

   void writeSFixed64List(int var1, List var2, boolean var3) throws IOException;

   void writeSInt32List(int var1, List var2, boolean var3) throws IOException;

   void writeSInt64List(int var1, List var2, boolean var3) throws IOException;
   ...
   void writeMap(int var1, MapEntryLite.Metadata var2, Map var3) throws IOException;
