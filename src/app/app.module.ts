...
@NgModule({
  declarations: [AppComponent, DriverLoginComponent, NavigatelocationComponent, SignatureComponent, TimeSlotPipe, MaindriverdashboardComponent, CanceldialogueComponent, NavigatelocationComponent],
  entryComponents: [],
